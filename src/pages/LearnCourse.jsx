          ...
          toast.success(
            <div>
              <p>
                ...
                {Math.round(response.data.attempt.percentageScore)}%
              </p>
              <p>You earned:</p>
              {response.data.attempt.badgesAwarded.map(reward => (
                <div key={reward._id} className='flex items-center mt-2'>
                  {reward.imageUrl && (
                    <img
                      src={reward.imageUrl}
                      alt={reward.name}
              ...
              {/* <div className="p-6 border-b border-neutral-200">
                <div className="flex justify-between items-start">
                  ...
                  <div className="flex items-center space-x-2">
                    <button
                      onClick={() => markLessonComplete(lessonId, !isLessonCompleted)}
                      className={`flex items-center px-3 py-1.5 rounded-full text-sm ${isLessonCompleted ? 'bg-green-100 text-green-800' : 'bg-neutral-100 text-neutral-800'}`}
                    >
                      {isLessonCompleted ? (
                        <>
